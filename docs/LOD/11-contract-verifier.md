...
|------------|--------------------|
| LOD-REQ-GEN | Все инварианты I1–I7 проверяются здесь. Отключаемость в production |
...
### LOD-CV-005: GEN2 — Внутренние стыки split
**Приоритет:** high
**Статус:** не реализовано
...
### LOD-CV-006: GEN2 — Внешний периметр
**Приоритет:** high
**Статус:** не реализовано
...
### LOD-CV-007: GEN2 — Round-trip (split → merge)
**Приоритет:** high
**Статус:** не реализовано
...
### LOD-CV-008: GEN3 — Совпадение контрактов
**Приоритет:** high
**Статус:** не реализовано
...
### LOD-CV-010: Cross-face непрерывность
**Приоритет:** medium
**Статус:** не реализовано
