...
### Состав меша (scale = 0.01, 1 unit = 1 km → самолёт ~25 м длины)
...
| Часть | BoxGeometry | После scale×0.01 | В метрах |
|-------|-----------|-----------------|---------|
| Фюзеляж | 0.35 × 0.35 × 2.5 | 0.0035 × 0.0035 × 0.025 | 3.5 × 3.5 × 25 м |
| Нос | 0.25 × 0.25 × 0.3 | 0.0025 × 0.0025 × 0.003 | 2.5 × 2.5 × 3 м |
| Кабина | 0.2 × 0.12 × 0.4 | 0.002 × 0.0012 × 0.004 | 2 × 1.2 × 4 м |
| Крылья | 4.0 × 0.04 × 0.08 | 0.04 × 0.0004 × 0.0008 | 40 × 0.4 × 0.8 м |
| Хвост. стаб. | 1.2 × 0.04 × 0.08 | 0.012 × 0.0004 × 0.0008 | 12 × 0.4 × 0.8 м |
| Киль | 0.3 × 0.6 × 0.08 | 0.003 × 0.006 × 0.0008 | 3 × 6 × 0.8 м |
